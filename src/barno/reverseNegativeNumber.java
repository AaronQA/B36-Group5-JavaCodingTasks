package barno;
    ...
    public static int reverseNegativeNumber1(int num){
        ...
        public static void main(String[] args) {
            System.out.println(reverseNegativeNumber1(-50));
            System.out.println(reverseNegativeNumber2(-5770));
            System.out.println(reverseNegativeNumber2(-5778));
        }
/*
